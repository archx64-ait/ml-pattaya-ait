...
class DetectionForm(forms.Form):
    ...
    total_bad_depth = forms.IntegerField(min_value=0, max_value=120, required=True)
    total_good_depth = forms.IntegerField(min_value=0, max_value=100, required=True)
